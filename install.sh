...
echo "=========================================================================="
echo "|                                                                        |"
echo "|    full-stack-proxy-nginx-fuelphp-for-everyone-with-docker-compose     |"
echo "|                        by Erdal ALTIN                                  |"
echo "|                                                                        |"
echo "=========================================================================="
sleep 2
...
if [ -x "$(command -v docker)" ] && [ "$(docker compose version)" ]; then
	...
	# installing FuelPHP and the other services
	docker compose up -d & export pid=$!
	echo "FuelPHP and the other services installing proceeding..."
	echo ""
	wait $pid
	if [ $? -eq 0 ]
	then
		...
		echo ""
		echo "Error! could not installed FuelPHP and the other services with docker compose" >&2
		exit 1
	fi
else
	echo ""
