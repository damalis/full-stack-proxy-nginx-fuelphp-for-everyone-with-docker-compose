# [full stack proxy nginx FuelPHP for everyone with docker compose](https://github.com/damalis/full-stack-proxy-nginx-fuelphp-for-everyone-with-docker-compose)

If You want to build a reverse proxy website with FuelPHP "webapp" at short time;

#### Full stack Proxy Nginx FuelPHP "webapp":
...
```
git clone https://github.com/damalis/full-stack-proxy-nginx-fuelphp-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-proxy-nginx-fuelphp-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
